 ...
 *
 * Example:
 *   node update-workflow.js https://n8n.example.com your-api-key workflowId123
 */
...
if (!n8nUrl || !apiKey || !workflowId) {
  ...
  console.error('Example: node update-workflow.js https://n8n.example.com your-api-key workflowId123');
  process.exit(1);
}
